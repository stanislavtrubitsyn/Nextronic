...
export default function AdminModeratorsPage() {
	...
	const [formData, setFormData] = useState<UserFormData>({
		...
		birthday: '',
		phone: '',
		role: 'moderator', // За замовчуванням створюємо модератора
	})
	...
	const filteredModerators = useMemo(() => {
		// Залишаємо лише модераторів
		let filtered = users.filter(u => u.role === 'moderator')
		...
		>
			...
			>
				<Table stickyHeader sx={{ borderCollapse: 'collapse' }}>
					...
					<TableBody>
						{filteredModerators.map((user, idx) => (
